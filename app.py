...
cc = bsc.get_container_client("lanternfly-images-m5t7jalw") # Replace with Container name cc.url will get you the url path to the container.  
app = Flask(__name__)
...
def gallery():
    items = [f"{cc.url}/{b.name}" for b in cc.list_blobs()]
